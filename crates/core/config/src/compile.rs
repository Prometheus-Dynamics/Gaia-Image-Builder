...
use gaia_spec::{
    ...
    ArtifactVariantSpec, AssemblyBusyboxInitramfsSpec, AssemblyDirSpec, AssemblyDiskPartitionSpec,
    AssemblyDiskSpec, AssemblyFileSpec, AssemblyFilesystemKindSpec, AssemblyFilesystemSpec,
    AssemblyPartitionTableSpec, AssemblySymlinkSpec, AssemblyTransformKindSpec,
    AssemblyTransformSpec, AssemblyTreeSpec, BuildMetadataSpec, BuildModeSpec, BuildPolicySpec,
    BuildrootCcachePolicySpec, BuildrootExpectedImageFormatSpec, BuildrootExpectedImageSpec,
    BuildrootExternalTreeModeSpec, BuildrootImageSpec, CheckpointAnchorRef, CheckpointBackendRef,
    CheckpointId, CheckpointPointSpec, CheckpointPolicy, CleanProfileSpec, CleanSpec,
    CommandProviderPolicySpec, DEFAULT_ARCHIVE_PROVIDER_TIMEOUT_SECONDS,
    DEFAULT_BUILDROOT_PROVIDER_TIMEOUT_SECONDS, DEFAULT_DOWNLOAD_PROVIDER_TIMEOUT_SECONDS,
